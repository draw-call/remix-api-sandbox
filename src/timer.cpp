...
AppTimer* WINAPI AppGetGlobalTimer() {
...
//--------------------------------------------------------------------------------------
void AppTimer::Advance() { m_llStopTime += m_llQPFTicksPerSec / 10; }

//--------------------------------------------------------------------------------------
double AppTimer::GetAbsoluteTime() {
  LARGE_INTEGER qwTime = {0};
  QueryPerformanceCounter(&qwTime);
...
//--------------------------------------------------------------------------------------
void AppTimer::GetTimeValues(double* pfTime, double* pfAbsoluteTime, float* pfElapsedTime) {
...
//--------------------------------------------------------------------------------------
LARGE_INTEGER AppTimer::GetAdjustedCurrentTime() {
...
//--------------------------------------------------------------------------------------
bool AppTimer::IsStopped() { return m_bTimerStopped; }
...
//--------------------------------------------------------------------------------------
void AppTimer::LimitThreadAffinityToCurrentProc() {
